...
====
*	Ice-plankton-capelin: critical for multivariate approach
*	Coral productivity: how extensive is the regime shift - is it community wide or the whole system
*	All biomass !=: more important for cod but gets at importance of older fish
*	Others:
  +	Are there good larval years – Hannah is looking after this.
  +	Seabird capelin consumption - a hole to plug?
...
Scatter1(df = cap, xaxis = rankB, yaxis = biomass_med, colour = year, 
...
Scatter1(df = cap, xaxis = year, yaxis = biomass_med, colour = rankB, 
...
bio_ld <- Scatter1(df = d_ld, xaxis = avg_densityt_2, yaxis = biomass_med, colour = year, 
...
bio_cond <- Scatter1(df = d_co, xaxis = condt_1, yaxis = biomass_med, colour = year, 
         c1 = "Year: ", c2 = "Cond: ", c3 = "Biomass: ", 
         xlab = "Condition (t-1)", ylab = "Capelin biomass (ktonnes)",
         filename = "figs/2-cond-year-rank.pdf", save = "no")

bio_mat <- Scatter1(df = d, xaxis = mat2t_1, yaxis = biomass_med, colour = year, 
...
# Empirical LRP Bmin - Haddock approach
...
```{r fig-8}
Bar1(df = cap, xaxis = year, yaxis = anomaly, c2 = "Biomass: ", c3 = "Anomaly: ", xlab = "Year", ylab = "Recruitment anomolies", hline = h90, filename = "figs/3-Biomass_all-year-anomaly.pdf", save = "no")
```
...
```{r fig-10}
Bar1(df = cap_postCollapse, xaxis = year, yaxis = anomaly, c2 = "Biomass: ", c3 = "Anomaly: ", xlab = "Year", ylab = "Recruitment anomolies", hline = h90_post, filename = "figs/5-Biomass_postCollapse-year-anomaly.pdf", save = "no")
```

### Post collapse: stock-recruit 

```{r fig-11}
Scatter2(df = cap_postCollapse, xaxis = biomass_med, yaxis = biomass_med_lead, c2 = "Biomass: ", c3 = "Recruitment: ", xlab = "Index (ktonnes)", ylab = "Recruitment (ktonnes)", vline1 = v90_post, vline2 = v50_post, filename = "figs/6-Biomass_postCollapse-index-recruit.pdf", save = "no")
```
