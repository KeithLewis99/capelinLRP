...
* Overview  
    ...
    - capelin life cycle and supporting studies surrounding the capelin forecast model (Lewis 2019) including figures showing that capelin biomass depends on larval density [@murphy2018re], the timing of ice retreat [@buren2014bottom], and capelin fall condition.  
    - references   
...
Overveiw of relevant capelin biology  
...
Scatter1(df = df_ld, xaxis = year, yaxis = avg_density, colour = rank, 
         c1 = "Rank: ", c2 = "Year: ", c3 = "Larvae: ", xlab = "Year", 
