...
#Available themes include: default, cerulean, journal, flatly, darkly, readable, spacelab, united, cosmo, , simplex.
library(knitr)
library(plotly)
library(ggplot2)
library(crosstalk)
...
BUT THE PROBLEM IS TEH SRR (SEE NEXT PAGE). WE CAN GET Fx%SPR but we can't get the SRR so we can't do LRPs.
