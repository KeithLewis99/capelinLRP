...
```{r}
Scatter1(df = df_ssb, xaxis = ssb, yaxis = abundance_tp2, colour = year,
         c1 = "Year: ", c2 = "Biomass: ", c3 = "Recruitment: ", 
         xlab = "Capelin spawning biomass (ktonnes)", ylab = "Recruitment (billions)",
         filename = "figs/2-cond-rank-year.pdf", save = "no")
```
...
### Post-collapse
```{r}
Scatter1(df = df_ssb[6:37, ], xaxis = ssb, yaxis = abundance_tp2, colour = year,
         c1 = "Year: ", c2 = "Biomass: ", c3 = "Recruitment: ", 
         xlab = "Capelin spawning biomass (ktonnes)", ylab = "Recruitment (billions)",
         filename = "figs/2-cond-rank-year.pdf", save = "no")
```
