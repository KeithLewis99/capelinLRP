...
Scatter1(df = df_bio, xaxis = year, yaxis = biomass, colour = NULL, 
         c2 = "Year: ", c3 = "Biomass: ", 
...
```{r}
Scatter1(df = df_bio, xaxis = year, yaxis = bio2, colour = NULL, 
         c2 = "Year: ", c3 = "Biomass: ", 
...
```{r}
Scatter1(df = df_bio, xaxis = year, yaxis = bio3, colour = NULL, 
         c2 = "Year: ", c3 = "Biomass: ", 
...
```{r}
Scatter1(df = df_bio, xaxis = year, yaxis = bio4, colour = NULL, 
         c2 = "Year: ", c3 = "Biomass: ", 
...
```{r}
Scatter1(df = df_bio, xaxis = year, yaxis = bio5, colour = NULL, 
         c2 = "Year: ", c3 = "Biomass: ", 
...
mat_fig <- Scatter1(df = d, xaxis = year, yaxis = mat2_tm1, colour = NULL, 
