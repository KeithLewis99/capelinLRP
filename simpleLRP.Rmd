...
Scatter1(df = df_lag, xaxis = year, yaxis = avg_density_lag2, colour = NULL, 
...
```{r}
par(mar= c(5, 4, 4, 2) + 0.1)
Scatter1(df = df_lag, xaxis = year, yaxis = cond_lag1, colour = NULL, 
         c1 = "Rank: ", c2 = "Year: ", c3 = "Cond: ", xlab = "Year", ylab = "Condition (x: t-1)",
         filename = "figs/2-cond-year-rank.pdf", save = "no")
...
```{r fig-7}
par(mar= c(5, 4, 4, 2) + 0.1)
Scatter1(df = df_lag, xaxis = year, yaxis = immat_lag3, colour = NULL, 
